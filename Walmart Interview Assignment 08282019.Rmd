...
### From data and chart and the corelation table 
# its clear that there is a weak relation between movie count per year and avg ratings
# and no impact of  avg ratings and number of reviews on the count of movies being made
