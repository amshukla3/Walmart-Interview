...
### From data and chart its clear that there is a weak connection between movie count and avg rating(0.7) but no impact of 
## number of reviews on the count of movies being made. The chart also suggests the same
